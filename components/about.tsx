...
export default function About() {
  ...
  return (
    ...
    >
      ...
      <p className="mb-3">
        🚀 My journey began at <a className="text-[#1a1162] underline" href="https://averlabz.com/" target="_blank">Averlabz</a>  in 2020. Since then, I've been deeply involved in leveraging the power of   <span className="font-medium">
          React, Next.js
